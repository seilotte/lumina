...
uniform sampler2D colortex2; // taa_previous_frame.rgb
...
//     vec3 col_avg;
    ...
    vec3 c00 = rgb_ycocg(texture(colortex0, uv - offsets11).rgb);
    vec3 c10 = rgb_ycocg(texture(colortex0, uv - offsets01).rgb);
    vec3 c01 = rgb_ycocg(texture(colortex0, uv + offsets01).rgb);
    vec3 c11 = rgb_ycocg(texture(colortex0, uv + offsets11).rgb);
